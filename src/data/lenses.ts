...
export const LENSES: Lens[] = [
  {
    ...
    metrics: [
      ...
      },
      {
        ...
        value: "2.6%",
        num: 2.6,
        context: "Fed DFA — half the country owns almost nothing",
        spectrum: {
          min: 0,
          max: 10,
          val: 2.6,
  ...
  },
  {
    ...
    metrics: [
      ...
      },
      {
        ...
        value: "$6.8T",
        num: 6.8,
        context: "WALCL — down from $9T peak, QT ongoing",
        spectrum: {
          min: 4,
          max: 10,
          val: 6.8,
  ...
  },
  {
    ...
    metrics: [
      ...
      },
      {
        ...
        value: "−14% YoY",
        num: -14,
        context: "BLS JOLTS — knowledge work canary",
        spectrum: {
          min: -50,
          max: 20,
          val: -14,
  ...
  },
  {
    ...
    metrics: [
      ...
      },
      {
        ...
        value: "$94.65/bbl",
        num: 94.65,
        context: "EIA daily spot — crisis premium from Iran escalation",
        big: true,
        spectrum: {
          min: 40,
          max: 150,
      ...
      },
      {
        ...
        value: "13.7M bbl/day",
        num: 13.7,
        context: "EIA monthly — near record but plateauing",
        spectrum: {
          min: 8,
          max: 16,
          val: 13.7,
